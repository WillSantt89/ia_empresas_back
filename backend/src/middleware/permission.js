...
const PERMISSION_MATRIX = {
  ...
  'tool-executions': {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR]
  },
  inboxes: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN],
  ...
  'whatsapp-numbers': {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN]
  },
  'api-keys': {
  ...
  usuarios: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN]
  },
  conversas: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    control: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR]
  },
  logs: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.OPERADOR, USER_ROLES.VIEWER]
  },
  ...
  filas: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN],
    manage_members: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR]
  },
  labels: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN],
  ...
  chat: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    send: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR]
  },
  contatos: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
