...
const PERMISSION_MATRIX = {
  ...
  conversas: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.OPERADOR],
  ...
  filas: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN]
  },
  labels: {
  ...
  chat: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.OPERADOR],
    send: [USER_ROLES.MASTER, USER_ROLES.ADMIN, USER_ROLES.OPERADOR]
  }
};
