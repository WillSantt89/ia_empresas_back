 ...
 *
 * admin_suporte (interno wschat) tem acesso técnico full em CADA empresa,
 * EXCETO recursos master-only (empresas, planos, itens-cobraveis, assinaturas,
 * dashboard-global, faturas write).
 *
 * admin (do cliente) PERDE recursos técnicos: agentes, prompts, tools,
 * tool-executions, api-keys, whatsapp-numbers, regras-roteamento,
 * automacoes-entrada, chatbot-fluxos, campos-personalizados, meta-*.
 */
const PERMISSION_MATRIX = {
  ...
  // Recursos técnicos — admin_suporte (wschat) faz, admin (cliente) NÃO vê mais
  agentes: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    test: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.OPERADOR]
  },
  prompts: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    activate: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE]
  },
  tools: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    test: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE]
  },
  'tool-executions': {
  ...
  'api-keys': {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    activate: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE],
    test: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE]
  },
  // Recursos compartilhados — admin_suporte e admin (cliente) tem acesso
  usuarios: {
    ...
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN]
  },
  conversas: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    control: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR]
  },
  logs: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.OPERADOR, USER_ROLES.VIEWER]
  },
  ...
  configuracoes: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN]
  },
  notificacoes: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.OPERADOR, USER_ROLES.VIEWER],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN]
  ...
  faturas: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN],
    write: [USER_ROLES.MASTER]
  },
  filas: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN],
    delete: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN],
    manage_members: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR]
  },
  labels: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN],
  ...
  chat: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    send: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR]
  },
  contatos: {
    read: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
    write: [USER_ROLES.MASTER, USER_ROLES.ADMIN_SUPORTE, USER_ROLES.ADMIN, USER_ROLES.SUPERVISOR, USER_ROLES.OPERADOR],
